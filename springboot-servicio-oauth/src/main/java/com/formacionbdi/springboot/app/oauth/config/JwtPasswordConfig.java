...
public class JwtPasswordConfig {
	...
	/* Generación de las clave publicas y privadas con openssl 
		
		Genera el certificado: C:\Program Files\OpenSSL-Win64\bin>openssl genrsa -out jwt.pem
		Obtenemos la clave privada: C:\Program Files\OpenSSL-Win64\bin>openssl rsa -in jwt.pem
		Obtenemos la clave publica: C:\Program Files\OpenSSL-Win64\bin>openssl rsa -in jwt.pem -pubout
